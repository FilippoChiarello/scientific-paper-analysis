...
library(rebus)
library(tidygraph)
library(GGally) # visualize multi correlation


# read back the list of multi-words
social_robotics_multi <- read_lines("data/wip/social_robotics_multi.txt")
...
# visualize previosuly plot with a filter
...
write_rds(switch_table, "data/wip/switch_table.rds")
